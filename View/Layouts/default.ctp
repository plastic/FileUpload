...
<head>
	...
	<link rel="stylesheet" href="<?php echo Router::url('/', true) ?>file_upload/css/bootstrap-responsive.min.css">
	<!--[if lt IE 7]><link rel="stylesheet" href="http://blueimp.github.com/cdn/css/bootstrap-ie6.min.css"><![endif]-->
	<link rel="stylesheet" href="<?php echo Router::url('/', true) ?>file_upload/css/bootstrap-image-gallery.min.css">
